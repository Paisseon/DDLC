...
label yuri_exclusive2_2_ch22:
    ...
    #TODO<renpy.ast.ShowLayer object at 0x067D8A78>
    $ y_name = "???"
    ...
    show noise at noise_alpha zorder 100 
    show vignette at vignetteflicker(-2.030) zorder 100 
    #TODO<renpy.ast.ShowLayer object at 0x067D8FB8>
    ...
    hide noise 
    hide vignette 
    #TODO<renpy.ast.ShowLayer object at 0x067DE298>
    ...
    stop music
    #TODO<renpy.ast.ShowLayer object at 0x0681DED8>
    hide yuripupils 
...
label yuri_exclusive2_2_ch23:
    ...
    y "Wait..."
    y "How did I..."
    y "...Sorry, I just had a really weird déjà vu..."
    ...
    y "..."
    play music hb
    #TODO<renpy.ast.ShowLayer object at 0x0682F0D8>

label ch3_main:
    ...
    m "But I'm surprised I'm not the one asking you, [player]."
    ...
    m "I'm saying that maybe the thing on her mind is you, [player]."
    mc "Me...?"
...
label ch3_end:
    ...
    m "In the end, I think it's up to [player] to decide how he'd like to contribute."
    m "Besides..."
...
label ch3_end_monika:
    ...
    show yuri 2g 
    m "Sigh..."
    m "It's...technically most logical for [player] to help one of you two."
    m "So..."
...
label ch3_end_yuri:
    ...
    show natsuki at t31 zorder 2 
    show monika at f32 zorder 3 
    m "So, you'll be helping Yuri then, [player]?"
    show monika at t32 zorder 2 
    mc "Yeah."
    ...
    y "I don't really know why [player] picked me..."
    y "And also..."
    ...
    y "Don't underestimate yourself, [player]."

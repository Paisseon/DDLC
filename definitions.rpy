...
init python:
    ...
    define t1 = "<loop 22.073>bgm/1.ogg"
    define t2 = "<loop 4.499>bgm/2.ogg"
    define t2g = "bgm/2g.ogg"
    define t2g2 = "<from 4.499 loop 4.499>bgm/2.ogg"
    define t2g3 = "<loop 4.492>bgm/2g2.ogg"
    define t3 = "<loop 4.618>bgm/3.ogg"
    define t3g = "<to 15.255>bgm/3g.ogg"
    define t3g2 = "<from 15.255 loop 4.618>bgm/3.ogg"
    define t3g3 = "<loop 4.618>bgm/3g2.ogg"
    define t3m = "<loop 4.618>bgm/3.ogg"
    define t4 = "<loop 19.451>bgm/4.ogg"
    define t4g = "<loop 1.000>bgm/4g.ogg"
    define t5 = "<loop 4.444>bgm/5.ogg"
    define t5b = "<loop 4.444>bgm/5.ogg"
    define t5c = "<loop 4.444>bgm/5.ogg"
    define t6 = "<loop 10.893>bgm/6.ogg"
    define t6g = "<loop 10.893>bgm/6g.ogg"
    define t6r = "<to 39.817 loop 0>bgm/6r.ogg"
    define t6s = "<loop 43.572>bgm/6s.ogg"
    define t7 = "<loop 2.291>bgm/7.ogg"
    define t7a = "<loop 4.316 to 12.453>bgm/7.ogg"
    define t7g = "<loop 31.880>bgm/7g.ogg"
    define t8 = "<loop 9.938>bgm/8.ogg"
    define t9 = "<loop 3.172>bgm/9.ogg"
    define t9g = "<loop 1.532>bgm/9g.ogg"
    define t10 = "<loop 5.861>bgm/10.ogg"
    define t10y = "<loop 0>bgm/10-yuri.ogg"
    define td = "<loop 36.782>bgm/d.ogg"

    define m1 = "<loop 0>bgm/m1.ogg"
    define mend = "<loop 6.424>bgm/monika-end.ogg"

    define ghostmenu = "<loop 0>bgm/ghostmenu.ogg"
    define g1 = "<loop 0>bgm/g1.ogg"
    define g2 = "<loop 0>bgm/g2.ogg"
    define hb = "<loop 0>bgm/heartbeat.ogg"

    define closet_open = "sfx/closet-open.ogg"
    define closet_close = "sfx/closet-close.ogg"
    define page_turn = "sfx/pageflip.ogg"
    define fall = "sfx/fall.ogg"
    ...
    default yuri_kill = 0
    default seen_eyes = None
    default seen_sticker = None
    default ghost_menu = None
    default seen_ghost_menu = None
    default seen_eyes_this_chapter = False
    default anticheat = 0
    default clear = [False, False, False, False, False, False, False, False, False, False]
    default special_poems = None
    default clearall = None
    default menu_bg_m = None
    default first_load = None
    default first_poem = None
    default seen_colors_poem = None
    default monika_back = None

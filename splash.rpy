init python:
    menu_trans_time = 1
    splash_message_default = "iOS port by Paisseon\nThanks to saber-nyan"
    splash_messages = [
    "You are my sunshine,\nMy only sunshine",
    "I missed you.",
    "Play with me",
...
label readonly:  # TO!DONE: find usages!
    ...
    "So, if you're getting this ending, tell Paisseon, okay?"
    "They'll fix it, or maybe not. Sometimes they just don't feel like it."
    "Chances are though..."
...
# Decompiled with Ren'Py Script Decompiler: https://github.com/lolbot-iichan/decompile.rpy

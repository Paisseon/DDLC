label ch21_main:
    ...
    #TODO<renpy.ast.ShowLayer object at 0x05F22030>
    ...
    hide yuri 
    #TODO<renpy.ast.ShowLayer object at 0x05F272D0>
...
label ch21_end:
    ...
    show vignette at vignetteflicker(timeleft) as flicker zorder 4 
    show vignette at vignettefade(timeleft) zorder 4 
    #TODO<renpy.ast.ShowLayer object at 0x05F35DF8>
    ...
    label menu_click:
        $ srf = screenshot_srf()
        #TODO<renpy.ast.ShowLayer object at 0x06042030>
        ...
        $ menu_clicked += 1
        if menu_clicked < 9:
            #TODO<renpy.ast.ShowLayer object at 0x060420A0>



            #TODO<renpy.ast.ShowLayer object at 0x060420D8>
    ...
    $ menu_clicked = 8
    $ quick_menu = False
    #TODO<renpy.ast.ShowLayer object at 0x060421B8>



    #TODO<renpy.ast.ShowLayer object at 0x060421F0>
    ...
    m "..."
    #TODO<renpy.ast.ShowLayer object at 0x06042308>
    #TODO<renpy.ast.ShowLayer object at 0x06042340>
    show monika 1 at i11 onlayer front 
    window auto
    $ renpy.display_menu(items=[('Natsuki.', True), ('Yuri.', True)], interact=False, screen='choice')
    m "..."
    ...
    y "But I really appreciate you understan{fast}[gtext] [gtext][gtext]{nw}"
    $ _history_list.pop()
    hide monika onlayer front 
    window hide(None)
    window auto

...
label ch22_main:
    ...
    if renpy.random.randint(0, 3) == 0:
        $ style.say_dialogue = style.edited
        show yuri at t32 zorder 2 
        show natsuki mouth at i33 as nm zorder 3 
...
label ch22_end:
    ...
    if faint_effect:
        #TODO<renpy.ast.ShowLayer object at 0x060A8A08>
        #TODO<renpy.ast.ShowLayer object at 0x060A8A40>
    ...
    if faint_effect:
        ...
        #TODO<renpy.ast.ShowLayer object at 0x060AE378>
        #TODO<renpy.ast.ShowLayer object at 0x060AE3B0>
    ...
    m "I'm sure Yuri and [player] want to get more members too..."
    m "...Right?"
    show monika at t32 zorder 2 

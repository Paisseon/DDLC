...
label ch3_y_end:
    ...
    if not n_readpoem or n_appeal >= 3:
        ...
        y "After yesterday, Natsuki and I...well..."
...
label ch3_y_end_special:
    ...
    y "I guess...we should move on before Monika says something."
...
label ch2_n_end:
    ...
    if y_readpoem and (y_poemappeal[0] >= 0 or y_poemappeal[1] >= 0):
        ...
        n "Really?"
        n "Well..."
        n "I mean, Yuri's pretty weird, so I wouldn't doubt that she has some weird hobbies..."
        ...
        n "And Yuri made me feel insecure yesterday!"
...
label ch3_n_end:
    ...
    if not y_readpoem or y_appeal >= 3:
        ...
        n "I mean, after Yuri and I realized we kind of wrote about the same thing..."
...
label ch2_s_end:
    ...
    s "Monika taught me a whole lot!"
...
label ch2_n_bad:
    ...
    if n_poemappeal[0] < 0:
        ...
        label ch2_n_bad_sharedwithch3:
            ...
            n "Honestly... Don't bother trying to write poems like this until you're on Yuri's level--"
            show natsuki 4o 
            ...
            n "You know Yuri would love this kind of...this angsty.......!!"
        ...
        n "Yuri's head over heels for all this cryptic nonsense, but I see right through that BS. Hah!"
...
label ch2_n_med:
    ...
    if n_poemappeal[0] < 0:
        ...
        label ch2_n_med_shared:
            n "Come to think of it, this kind of reminds me of Sayori's poem from yesterday..."
            mc "Eh? You think so?"
...
label ch2_n_good:
    ...
    if n_poemappeal[0] != 1:
        ...
        label ch2_n_good_sharedwithch3:
            ...
            n "Obviously! You think I'd let you enjoy Yuri's writing more than mine?"
            n "Give me a break."
            mc "Well..."
            ...
            if poemsread >= 3:
                ...
                show natsuki at t21 zorder 2 
                show monika at f22 zorder 3 
                m "Well... I guess [player] is right, Natsuki..."
...
label ch3_n_bad:
    ...
    if n_poemappeal[0] < 0 and n_poemappeal[1] < 0:
        ...
        n "As long as you're not just trying to impress Yuri or something like that."
        n "Gross."
        mc "Okay, okay."
...
label ch3_s_bad:
    ...
    mc "Sayori...?"
    s "Tell Monika I wasn't feeling well, okay?"
...
label ch1_y_bad:
    ...
    label ch1_y_shared:
        ...
        y "Natsuki can be a little bit biased, though..."
        mc "Biased? How?"
        y "U-Um..."
        y "Well..."
        y "Never mind..."
...
label m_sayori_1:
    ...
    mc "Is that so?"
    m "You and Sayori are really good friends, right?"
    ...
    m "...But in any case, Sayori's writing has kind of a gentle feel to it."
...
label m_yuri_1:
    ...
    m "Unlike Sayori, who likes using simple and direct words to describe happiness and sadness..."
...
label m_natsuki_2:
    m "It's pretty good~"
    m "You've been spending some time with Natsuki, haven't you?"
...
label m_sayori_2:
    m "It's pretty good~"
    m "It makes me think of Sayori, like the other one that you wrote."
    ...
    m "Ahaha! I'm just teasing."
    m "I know it takes a bit of time to make friends with everyone."
    m "But Yuri and Natsuki are super interesting people, so don't be afraid to give them their share of time!"
...
label m_yuri_2:
    ...
    m "Just wondering, but have you been finding inspiration in Yuri's writing style?"
    mc "Hmm..."
    mc "I guess so."
...
label m_natsuki_3:
    m "Sticking with the Natsuki style once more, I see~"
    m "Hmm..."
    ...
    m "And you wouldn't do that to me...right?"
    mc "That's--"
...
label m_sayori_3:
    ...
    mc "How so?"
    m "No, not the poem..."
    m "I mean, it's funny how your poems and Sayori's poems have been getting more and more similar to each other every day."
    ...
    m "Sayori's been acting so much happier ever since you joined the club."
